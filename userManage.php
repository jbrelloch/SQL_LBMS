...
<body>
    ...
    <div class="container">
			<div class="row">
				<div class="col-lg-12">
					<h1 id="tables">User Management</h1>
					...
					<div class="bs-example table-responsive">
							...
							<tbody>
								<?php
									...
									if(isset($_GET['offset']))
									{
										...
										$result = mysql_query("SELECT * FROM members LIMIT $totalOffset,20") or die("Unable to connect to query");
									}
									else
									{
										$result = mysql_query("SELECT * FROM members LIMIT 20") or die("Unable to connect to query");
									}
						...
						<?php 
							require 'connect.php';
							$result = mysql_query("SELECT * FROM members") or die("Unable to connect to query");
							$result_count = mysql_num_rows($result);
